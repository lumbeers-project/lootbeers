    ...
    return (
        <div className="App2">
            ...
            <div className="MainBlock">
                ...
                <div style={{ color: 'white', position: 'relative', fontSize: '18px', fontFamily: 'GraphikLCG-Regular', whiteSpace: 'nowrap' }} className="balanceStyle">
                    <>
            ...
            <div className='menuToggleBlock'>
                <div id="menuToggle">
                    ...
                    <span></span>
                    <ul id="menu">
                        <li className='secondMenuElement'>
                            <div style={{ color: 'white', position: 'relative', fontSize: '18px', fontFamily: 'GraphikLCG-Regular', whiteSpace: 'nowrap' }} className="balanceStyle">
                                <>
                                    {balance?.toFixed(2)} SOL
                                </>
                        ...
                        <li className='MenuElement thirdMenuElement'>FAQ</li>
                        <li className='MenuElement fourthMenuElement'>ROADMAP</li>
                        <li className='MenuElement fifthMenuElement'>SITE</li>
            ...
            <BrowserRouter>
                <Routes>
                    <Route path="/lootbeers_ts" element={<Main />} />
                    <Route index element={<Main />} />
                    <Route path="/lootbeers_ts/LootboxComponent" element={<LootboxComponent />} />
                </Routes>
            </BrowserRouter>
        </div>
    )
